# Comparing `tmp/flet_pyodide-0.22.0.dev2609.tar.gz` & `tmp/flet_pyodide-0.9.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "flet_pyodide-0.22.0.dev2609.tar", max compression
+gzip compressed data, was "flet_pyodide-0.9.0.tar", max compression
```

## Comparing `flet_pyodide-0.22.0.dev2609.tar` & `flet_pyodide-0.9.0.tar`

### file list

```diff
@@ -1,10 +1,10 @@
--rw-r--r--   0        0        0     2264 2024-04-05 19:47:30.248509 flet_pyodide-0.22.0.dev2609/README.md
--rw-r--r--   0        0        0      646 2024-04-05 19:48:05.553979 flet_pyodide-0.22.0.dev2609/pyproject.toml
--rw-r--r--   0        0        0      193 2024-04-05 19:47:30.248509 flet_pyodide-0.22.0.dev2609/src/flet/__init__.py
--rw-r--r--   0        0        0       31 2024-04-05 19:47:30.248509 flet_pyodide-0.22.0.dev2609/src/flet/canvas/__init__.py
--rw-r--r--   0        0        0     2169 2024-04-05 19:47:30.248509 flet_pyodide-0.22.0.dev2609/src/flet/flet.py
--rw-r--r--   0        0        0       55 2024-04-05 19:47:30.248509 flet_pyodide-0.22.0.dev2609/src/flet/matplotlib_chart.py
--rw-r--r--   0        0        0       47 2024-04-05 19:47:30.248509 flet_pyodide-0.22.0.dev2609/src/flet/plotly_chart.py
--rw-r--r--   0        0        0     3581 2024-04-05 19:47:30.248509 flet_pyodide-0.22.0.dev2609/src/flet/pyodide_connection.py
--rw-r--r--   0        0        0      103 2024-04-05 19:47:30.248509 flet_pyodide-0.22.0.dev2609/src/flet/version.py
--rw-r--r--   0        0        0     3060 1970-01-01 00:00:00.000000 flet_pyodide-0.22.0.dev2609/PKG-INFO
...
### Comparing `flet_pyodide-0.22.0.dev2609/README.md` & `flet_pyodide-0.9.0/README.md`

 * *Files identical despite different names*

### Comparing `flet_pyodide-0.22.0.dev2609/src/flet/flet.py` & `flet_pyodide-0.9.0/src/flet/flet.py`
...
### Comparing `flet_pyodide-0.22.0.dev2609/src/flet/pyodide_connection.py` & `flet_pyodide-0.9.0/src/flet/pyodide_connection.py`
...
### Comparing `flet_pyodide-0.22.0.dev2609/PKG-INFO` & `flet_pyodide-0.9.0/PKG-INFO`
